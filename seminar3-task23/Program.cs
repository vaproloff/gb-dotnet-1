...
// Способ 1. Построчный вывод таблицы кубов с табуляцией
...
// Способ 2. Строим таблицу с разделителями и равными ячейками
...
if (int.TryParse(inputLine, out inputNumber))
{
    // Получаем количество столбцов. Если не ввести ничего - будет 10
    int columnQty;
